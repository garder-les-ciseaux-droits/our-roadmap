...
const _routes = [
  {
    name: "about",
    path: "/about",
    component: () => import('./about-D7GKgkHR.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-ogI0V7Kf.mjs')
  },
  {
    name: "items-id",
    path: "/items/:id()",
    component: () => import('./_id_-C4_SyzBV.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DdMjNHqI.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-B64KGEc2.mjs'));
...
export { _export_sfc as _, useRoute as a, useRouter as b, useRuntimeConfig as c, nuxtLinkDefaults as d, entry_default as default, navigateTo as n, resolveRouteObject as r, useNuxtApp as u };
